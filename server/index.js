...
app.use(helmet({referrerPolicy:{policy:'strict-origin-when-cross-origin'},contentSecurityPolicy:{directives:{defaultSrc:["'self'"],scriptSrc:["'self'",'https://www.youtube.com','https://s.ytimg.com'],styleSrc:["'self'","'unsafe-inline'"],imgSrc:["'self'",'data:','https:'],connectSrc:["'self'",'https:','wss:','ws:'],mediaSrc:["'self'",'https:','http:','blob:'],frameSrc:["'self'",'https:'],workerSrc:["'self'",'blob:']}},crossOriginEmbedderPolicy:false}));
